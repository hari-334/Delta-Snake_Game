...
window.alert("Welcome To The Game..!!! If you eat the food in the shown sequence you will gain 5 seconds exrtra and 3 points");
...
const leaderTable = document.querySelector(".leaderBox");
const leaderButton = document.querySelector(".leaderBtn");
